...
public class MainController {
    ...
    public String testPage(@RequestParam(defaultValue = "ru")String lng , ModelMap model){
        ...
        if(lng.equals("by")){
            ...
            history = "<h2 class=\"major\">Прафесія і хобі. </h2><p>Працяглы час я працаваў у сферы абслугоўвання і рамонту на вядучым горна-здабываючым прадпрыемстве рэспублікі. Праграмаванне на java было заняткам для душы. Аднак пасля падзей лета 2020 я прыняў рашэнне цалкам змяніць прафесію.</p>";
            retraining = "<h2 class=\"major\">Перанавучанне.</h2><p> Па ментарскай праграме перанавучання ад \"ByHelp\" я пад кіраўніцтвам праграміста з 12-гадовым стажам вывучаў наступныя тэхналогіі : <b>Spring framework</b>, <b>Git</b>, <b>SQL</b>, <b>HTML</b>, <b>CSS</b>, <b>JS</b>.</p>";
        ...
        if(lng.equals("ru")){
            ...
            history = "<h2 class=\"major\">Профессия и хобби.</h2><p>Продолжительное время я работал в сфере обслуживания и ремонта на ведущем горно-добывающем предприятии республики. Программирование на java было занятием для души. Однако после событий лета 2020 я принял решение полностью сменить профессию. </p>";
            retraining = "<h2 class=\"major\">Переобучение.</h2><p>По менторской программе переобучения от \"ByHelp\" я под руководством программиста с 12-летним стажем изучал следующие технологии : <b>Spring framework</b>, <b>Git</b>, <b>SQL</b>, <b>HTML</b>, <b>CSS</b>, <b>JS</b>.</p>";
        ...
        if(lng.equals("eng")){
            ...
            history = "<h2 class=\"major\">Profession and hobby.</h2><p> For a long time I worked in the field of maintenance and repair at the leading mining enterprise of the republic. Java programming was a hobby. However, after the events of summer 2020, I decided to completely change my profession. </p>";
            retraining = "<h2 class=\"major\">Retraining.</h2><p>Under the mentor retraining program from \"ByHelp\", I studied the following technologies under the guidance of a 12-year programmer : <b>Spring framework</b>, <b>Git</b>, <b>SQL</b>, <b>HTML</b>, <b>CSS</b>, <b>JS</b>.</p>";
